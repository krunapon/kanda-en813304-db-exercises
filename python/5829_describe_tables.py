...
try:
    ...
    with connect(
        ...
        print("Describing 'movies' table structure:")
        ...
        with connection.cursor() as cursor:
            ...
            for row in description:
                print(row)
        print("-" * 50)
        # Describe the structure of the reviewers    table
        print("Describing 'reviewers' table structure:")
        ...
        print("-" * 50)
        # Describe the structure of the movies table
        print("Describing 'ratings' table structure:")
